...
export const projects: Project[] = [
  {
    title: "Police2Peer Map",
    description:
      "A live-map displaying downloads of what appears to be child sexual abuse material. Made as part of my job for the Norwegian Police (KRIPOS).",
    moreInfoUrl: "https://www.politiet.no/en/english/police2peer",
    liveUrl: "https://police2peer.politiet.no/",
    image: "https://police2peer.politiet.no/og.png",
  },
  {
